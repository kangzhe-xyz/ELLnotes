...
\begin{document}
    ...
    Turfing entails creating connetions even when there is no historical personal link to the ethnic community (Wray et al, 2003), so a person can `turf' an identity by enacting certain salient practices that are associated with a particular ethnicity.
\end{document}