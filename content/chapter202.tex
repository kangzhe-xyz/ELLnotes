...
\section{Language Variants, Standard Languages, National Languages, and Venaculars}
    ...
    \edfn{Vernacular Language}{A vernacular is a language that is spoken by the people in a certain region.}
    \edfn{National Language}{A national language is a language that identifies with the people of the nation, and possibly by extension the region itself.}
    \edfn{Standard Language}{A standard language is a ...}
    \edfn{Lingua Franca}{A lingua franca is formed when two speakers do not have a common language but have to communicate.}
