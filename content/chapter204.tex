...
\begin{document}
    ...
    \subsection{Linguistic Studies}
        ...
        \edfn{Isogloss}{An isogloss is a line drawn on a map separating areas according to a particular linguistic feature such as lexis, sounds, grammar. They mark clearly areas which a feature is found from those adjacent areas which it is not recorded or ocurs exceptionally.}

        \exmp{Isogloss of France}{\includegraphics[width=\textwidth]{content/graphics/isogloss.jpg}}

        \subsection{Dialect Levelling}
        \edfn{Dialect Leveling}{Dialect leveling refers to the means by which dialect differences decrease.}
